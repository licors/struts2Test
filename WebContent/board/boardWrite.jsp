	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="500" bgcolor="#FFFFFF">
				<s:textfield name="subject" theme="simple" value="%{resultClass.subject}" cssStyle="width:370px" maxlength="50"></s:textfield>
			</td>
		</tr>
		<tr bgcolor="#777777">
			<td height="1" colspan="2"></td>
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
				<s:textfield name="name" theme="simple" value="%{resultClass.name}" cssStyle="width:100px" maxlength="20"></s:textfield>
			</td>
		</tr>
		<tr bgcolor="#777777">
			<td height="1" colspan="2"></td>
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
				<s:textfield name="password" theme="simple" value="%{resultClass.password}" cssStyle="width:100px" maxlength="20"></s:textfield>
			</td>
		</tr><tr bgcolor="#777777">
			<td height="1" colspan="2"></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" colspan="2">
				...
				<input name="list" type="button" value="목록" class="inputb" onclick="javascript:location.href='listAction.aciton?currentPage=<s:property value="currentPage"/>'">
			</td>
		</tr>	
	</table>
	</form>
